...
class TestToolPatternMatching:
    ...
    async def test_all_tools_pattern(self, setup_test_tools):
        ...
        async with Agent("You are a universal assistant", tools=["*"]) as agent:
    ...
    async def test_mixed_patterns_and_instances(self, setup_test_tools):
        ...
        async with Agent(
            "You are a mixed assistant", tools=["weather:*", custom_tool]
        ) as agent:
    ...
    async def test_nonexistent_pattern(self, setup_test_tools):
        ...
        async with Agent(
            "You are an assistant", tools=["nonexistent:*", "fake_tool"]
        ) as agent:

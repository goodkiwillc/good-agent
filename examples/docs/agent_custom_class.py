...
class DataAnalyst(Agent):
    def __init__(self, **config):
        ...
        # Use sync registration in __init__ since we can't await here
        self.tools.register_tool_sync("analyze_data", self.analyze_data)
        self.tools.register_tool_sync("create_chart", self.create_chart)
